...
const resources = {
  en: {
    translation: {
      ...
      signInDescription: 'Sign in with the credentials provided by your instructor.',
      fullName: 'Full Name',
      fullNamePlaceholder: 'First and last name',
      emailAddress: 'Email Address',
      emailAddressPlaceholder: 'your@email.com',
      phoneOptional: 'Phone (optional)',
      phoneOptionalPlaceholder: '(720) 000-0000',
      programEnroll: 'Program of choice',
      whyJoining: 'Why are you joining?',
  ...
  ar: {
    translation: {
      ...
      signInDescription: 'سجّل الدخول باستخدام بيانات الاعتماد التي يوفرها مدرسك.',
      ...
      phoneOptionalPlaceholder: '(720) 000-0000',
      programEnroll: 'البرنامج الذي ترغب في الانضمام إليه',
      whyJoining: 'لماذا تنضم؟',
  ...
  fa: {
    translation: {
      ...
      signInDescription: 'با اطلاعات کاربری که مدرس شما داده وارد شوید.',
      fullName: 'نام کامل',
      ...
      phoneOptionalPlaceholder: '(720) 000-0000',
      programEnroll: 'برنامه‌ای که می‌خواهید ثبت نام کنید',
      whyJoining: 'چرا می‌خواهید بپیوندید؟',
